...
class content():
    ...
    def load_lab_las(self, lasfilesdir, depth=False, dt=False, rt=False, gr=False, cali=False):
        ...
        for lasfilename in self.lasfilenames:
            ...
            if depth:
                self.depthmnem = depth
                self.mnemoics['depth'] = depth
            if dt:
                self.mnemoics['dt'] = dt
            if rt:
                self.mnemoics['rt'] = rt
